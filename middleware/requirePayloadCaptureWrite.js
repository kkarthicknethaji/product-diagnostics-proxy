...
//
// Composed check for the not-yet-built POST /v1/trace-payloads route —
// collapses two independently-remembered checks (the credential's own
// payloads:write scope, and the app's payload_capture_enabled toggle) into
// one middleware, so a future implementer can't wire only one of the two.
